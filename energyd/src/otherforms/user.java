...
public class user extends JFrame {
    ...
    public user() {
        ...
        add(nameField);
        add(new JLabel("Email:")).setBounds(10, 50, 80, 20);
        add(emailField);
    ...
    private void addUser() {
        try (Connection connection = getConnection()) {
            ...
            String insertQuery = "INSERT INTO user (name, email, role) VALUES (?, ?, ?)";
    ...
    private void updateUser() {
        try (Connection connection = getConnection()) {
            ...
            String updateQuery = "UPDATE user SET name=?, email=?, role=? WHERE id=?";
